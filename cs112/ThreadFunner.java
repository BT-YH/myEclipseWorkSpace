...
//		List<Integer> intList = new ArrayList<Integer>();
	...
	private void forkJoinTest() {
		...
		System.out.println("making the date takes " + duration + "ms");
		...
		max = maxTask.join();
		duration = System.currentTimeMillis() - startTime;
		System.out.println("Maximum " + max + " after " + duration + " ms with " + Runtime.getRuntime().availableProcessors() + " processors");		
