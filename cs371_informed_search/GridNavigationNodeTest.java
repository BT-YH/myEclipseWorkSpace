...
public class GridNavigationNodeTest {
	...
	public static void main(String[] args) throws IOException {
		...
		final int ROWS = 85, COLS = 79;
		Maze maze = new Maze(ROWS, COLS, 0);
		...
		GridNavigationNode node = (GridNavigationNode)searcher.goalNode;
		System.out.println(node + "\t" + node.getH() + "\t" + node.depth);
		
		// Map solution path onto image.
		GridNavigationNode pathNode = (GridNavigationNode) searcher.
				getGoalNode();
