...
public class RJMGenerator {
	...
	/**
	 * Generate a RookJumpingMaze of the given size and optimize it using a stochastic local search algorithm 
	 * of your choice, limited to a maximum of 5000 iterations.  
	...
	public static RookJumpingMaze generate(int size) {
		...
		RookJumpingMaze minState = state.search(iterations, 0.5, 0.99999);
		return minState;
	}
	...
	/**
	 * Generate a size 5 RookJumpingMaze object, print the RookJumpingMaze object, and print the energy of 
	 * the RookJumpingMaze object.
	 * @param args (not used)
	 */
