...
public class BK1MancalaNode extends MancalaNode {
	
	private static final int HALF_MARBLES = 24;
	private static final int WIN_POINTS = 1000000;
	
	
	public BK1MancalaNode() {
		super();
	}

	public BK1MancalaNode(MancalaNode node) {
		super(node);
	}

	public BK1MancalaNode(int stateIndex) {
		super(stateIndex);
	}
...
//	}
	...
	public double utility() {
		...
		// tunings
		double a = 1;
		double b = 0.100519788850594;
		//double c = 0;
		double d = 0.232950842330238;
		double e = 0.656260805811817;
		
		// linear regression constant
		double intercept = 38 * (-0.08696);
		if (player != MAX) {
			intercept = -intercept;
		}
		
		double heuristic = intercept + a * scoreDiff + b * mobDiff  + d * capDiff + e * pieDiff; // add tunings\
