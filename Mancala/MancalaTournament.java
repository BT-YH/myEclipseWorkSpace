...
public class MancalaTournament {
	...
	private static final int NUM_GAMES = 7; // TODO - set the number of games per match
	private static final long MILLISECONDS_PER_GAME =  15000; // TODO - set the maximum milliseconds per game
	...
	public static void main(String[] args) throws Exception {
		...
		String[] playerIdentifiers = {"BK", "ModSimple"};
	...
	private static int[] runGames(String player1, String player2, PrintWriter p) {
		try {
			...
			for (int g = 0; g < NUM_GAMES; g++) { // best of NUM_GAMES
				...
				int randomInitState = (int) (Math.random() * 255);
				System.out.println(randomInitState);
				MancalaNode node = new ScoreDiffMancalaNode(randomInitState);
				p.println(node);
